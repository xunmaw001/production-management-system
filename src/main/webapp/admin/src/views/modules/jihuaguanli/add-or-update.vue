    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="计划名称" prop="jihuamingcheng">
          <el-input v-model="ruleForm.jihuamingcheng" 
              placeholder="计划名称" clearable  :readonly="ro.jihuamingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="计划名称" prop="jihuamingcheng">
              <el-input v-model="ruleForm.jihuamingcheng" 
                placeholder="计划名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="实施人员" prop="shishirenyuan">
          <el-select  @change="shishirenyuanChange" v-model="ruleForm.shishirenyuan" placeholder="请选择实施人员">
            <el-option
                v-for="(item,index) in shishirenyuanOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.shishirenyuan" label="实施人员" prop="shishirenyuan">
              <el-input v-model="ruleForm.shishirenyuan" 
                placeholder="实施人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="材料使用量" prop="cailiaoshiyongliang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="材料使用量"
                  v-model="ruleForm.cailiaoshiyongliang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.cailiaoshiyongliang" label="材料使用量" prop="cailiaoshiyongliang">
                    <span>{{ruleForm.cailiaoshiyongliang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jihuamingcheng = true;
          ...
          if(o=='cailiaoshiyongliang'){
            this.ruleForm.cailiaoshiyongliang = obj[o];
	    this.ro.cailiaoshiyongliang = true;
            continue;
          }
          if(o=='kaishishijian'){
	    ...
	    this.ro.jieshushijian = true;
          ...
          if(o=='shishirenyuan'){
            this.ruleForm.shishirenyuan = obj[o];
	    this.ro.shishirenyuan = true;
            continue;
          }
          if(o=='xingming'){
    ...
    shishirenyuanChange () {
      this.$http({
        url: `follow/yuangong/gonghao?columnValue=`+ this.ruleForm.shishirenyuan,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jihuaguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jihuaguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
