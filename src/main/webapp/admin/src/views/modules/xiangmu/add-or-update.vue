<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="施工单位" prop="shigongdanwei">
          <el-input v-model="ruleForm.shigongdanwei" 
              placeholder="施工单位" clearable  :readonly="ro.shigongdanwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="施工单位" prop="shigongdanwei">
              <el-input v-model="ruleForm.shigongdanwei" 
                placeholder="施工单位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用地面积" prop="yongdimianji">
          <el-input v-model="ruleForm.yongdimianji" 
              placeholder="用地面积" clearable  :readonly="ro.yongdimianji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用地面积" prop="yongdimianji">
              <el-input v-model="ruleForm.yongdimianji" 
                placeholder="用地面积" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="项目经理" prop="xiangmujingli">
          <el-input v-model="ruleForm.xiangmujingli" 
              placeholder="项目经理" clearable  :readonly="ro.xiangmujingli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="项目经理" prop="xiangmujingli">
              <el-input v-model="ruleForm.xiangmujingli" 
                placeholder="项目经理" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="项目开始时间" prop="xiangmukaishishijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.xiangmukaishishijian" 
                type="date"
                placeholder="项目开始时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiangmukaishishijian" label="项目开始时间" prop="xiangmukaishishijian">
              <el-input v-model="ruleForm.xiangmukaishishijian" 
                placeholder="项目开始时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="项目结束时间" prop="xiangmujieshushijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.xiangmujieshushijian" 
                type="date"
                placeholder="项目结束时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiangmujieshushijian" label="项目结束时间" prop="xiangmujieshushijian">
              <el-input v-model="ruleForm.xiangmujieshushijian" 
                placeholder="项目结束时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangmumingcheng = true;
          ...
          if(o=='shigongdanwei'){
            this.ruleForm.shigongdanwei = obj[o];
	    this.ro.shigongdanwei = true;
            continue;
          }
          if(o=='yongdimianji'){
            this.ruleForm.yongdimianji = obj[o];
	    this.ro.yongdimianji = true;
            continue;
          }
          if(o=='xiangmuleixing'){
	    ...
	    this.ro.xiangmuleixing = true;
          ...
          if(o=='xiangmujingli'){
            this.ruleForm.xiangmujingli = obj[o];
	    this.ro.xiangmujingli = true;
            continue;
          }
          if(o=='xiangmukaishishijian'){
            this.ruleForm.xiangmukaishishijian = obj[o];
	    this.ro.xiangmukaishishijian = true;
            continue;
          }
          if(o=='xiangmujieshushijian'){
            this.ruleForm.xiangmujieshushijian = obj[o];
	    this.ro.xiangmujieshushijian = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/xiangmuleixing/leixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
