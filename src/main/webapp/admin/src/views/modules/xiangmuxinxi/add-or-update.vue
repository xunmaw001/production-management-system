<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工程进度" prop="gongchengjindu">
          <el-input v-model="ruleForm.gongchengjindu" 
              placeholder="工程进度" clearable  :readonly="ro.gongchengjindu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工程进度" prop="gongchengjindu">
              <el-input v-model="ruleForm.gongchengjindu" 
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="安全措施" prop="anquancuoshi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="安全措施"
                  v-model="ruleForm.anquancuoshi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.anquancuoshi" label="安全措施" prop="anquancuoshi">
                    <span>{{ruleForm.anquancuoshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="结构材料" prop="jiegoucailiao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="结构材料"
                  v-model="ruleForm.jiegoucailiao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiegoucailiao" label="结构材料" prop="jiegoucailiao">
                    <span>{{ruleForm.jiegoucailiao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="用量" prop="yongliang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="用量"
                  v-model="ruleForm.yongliang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yongliang" label="用量" prop="yongliang">
                    <span>{{ruleForm.yongliang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangmumingcheng = true;
          ...
          if(o=='anquancuoshi'){
            this.ruleForm.anquancuoshi = obj[o];
	    this.ro.anquancuoshi = true;
            continue;
          }
          if(o=='jiegoucailiao'){
            this.ruleForm.jiegoucailiao = obj[o];
	    this.ro.jiegoucailiao = true;
            continue;
          }
          if(o=='yongliang'){
	    ...
	    this.ro.yongliang = true;
          ...
          if(o=='gongchengjindu'){
            this.ruleForm.gongchengjindu = obj[o];
	    this.ro.gongchengjindu = true;
            continue;
          }
        }
      }
