...
import center from '@/views/center'
    ...
    import xiangmuwenjian from '@/views/modules/xiangmuwenjian/list'
    import jihuaguanli from '@/views/modules/jihuaguanli/list'
    import renyuantongxunlu from '@/views/modules/renyuantongxunlu/list'
...
const routes = [{
	...
	path: '/xiangmuwenjian',
        name: '项目文件',
        component: xiangmuwenjian
      }
      ,{
	path: '/jihuaguanli',
        name: '计划管理',
        component: jihuaguanli
      }
      ,{
	path: '/renyuantongxunlu',
        name: '人员通讯录',
        component: renyuantongxunlu
      }
      ,{
	path: '/storeup',
        name: '我的收藏管理',
